...
export class WJSCParser extends Parser {
	...
	public func(): FuncContext {
		...
		try {
			...
			if (((((_la - 49)) & ~0x1F) === 0 && ((1 << (_la - 49)) & ((1 << (WJSCParser.INTEGER - 49)) | (1 << (WJSCParser.BOOLEAN - 49)) | (1 << (WJSCParser.CHARACTER - 49)) | (1 << (WJSCParser.STRING - 49)) | (1 << (WJSCParser.PAIR - 49)) | (1 << (WJSCParser.ANY - 49)))) !== 0)) {
				{
				this.state = 72;
				this.paramList();
				}
