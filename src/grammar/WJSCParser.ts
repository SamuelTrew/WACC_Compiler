...
export class WJSCParser extends Parser {
	...
	public static readonly DONE = 27;
	public static readonly CALL = 28;
	public static readonly FIRST = 29;
	public static readonly SECOND = 30;
	...
	public static readonly LOGICAL_NEGATION = 47;
	public static readonly NEW_PAIR = 48;
	public static readonly LENGTH = 49;
	public static readonly ORDER_OF = 50;
	public static readonly CHARACTER_OF = 51;
	...
	public static readonly APOS = 69;
	public static readonly DBLQ = 70;
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		...
		"'else'", "'fi'", "'while'", "'for'", "'do'", "'done'", "'call'", "'fst'", 
		"'snd'", "'*'", "'/'", "'%'", "'+'", "'-'", "'>'", "'>='", "'<'", "'<='", 
		"'=='", "'==='", "'!='", "'!=='", "'&&'", "'||'", "'='", "'!'", "'newpair'", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		"FOR", "DO", "DONE", "CALL", "FIRST", "SECOND", "MULTIPLY", "DIVIDE", 
	...
	public program(): ProgramContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << WJSCParser.BEGIN) | (1 << WJSCParser.WSKIP) | (1 << WJSCParser.READ) | (1 << WJSCParser.FREE) | (1 << WJSCParser.RETURN) | (1 << WJSCParser.EXIT) | (1 << WJSCParser.PRINT) | (1 << WJSCParser.PRINTLN) | (1 << WJSCParser.IF) | (1 << WJSCParser.WHILE) | (1 << WJSCParser.FOR) | (1 << WJSCParser.FIRST) | (1 << WJSCParser.SECOND))) !== 0) || ((((_la - 57)) & ~0x1F) === 0 && ((1 << (_la - 57)) & ((1 << (WJSCParser.INTEGER - 57)) | (1 << (WJSCParser.BOOLEAN - 57)) | (1 << (WJSCParser.CHARACTER - 57)) | (1 << (WJSCParser.STRING - 57)) | (1 << (WJSCParser.PAIR - 57)) | (1 << (WJSCParser.ANY - 57)) | (1 << (WJSCParser.IDENTIFIER - 57)))) !== 0)) {
				{
				this.state = 75;
				this.statement(0);
				}
	...
	public func(): FuncContext {
		...
		try {
			...
			case 1:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (((((_la - 57)) & ~0x1F) === 0 && ((1 << (_la - 57)) & ((1 << (WJSCParser.INTEGER - 57)) | (1 << (WJSCParser.BOOLEAN - 57)) | (1 << (WJSCParser.CHARACTER - 57)) | (1 << (WJSCParser.STRING - 57)) | (1 << (WJSCParser.PAIR - 57)) | (1 << (WJSCParser.ANY - 57)))) !== 0)) {
					{
					this.state = 108;
					this.paramList();
					}
	...
	public assignRhs(): AssignRhsContext {
		...
		try {
			...
			case WJSCParser.CALL:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (WJSCParser.PLUS - 34)) | (1 << (WJSCParser.MINUS - 34)) | (1 << (WJSCParser.LOGICAL_NEGATION - 34)) | (1 << (WJSCParser.LENGTH - 34)) | (1 << (WJSCParser.ORDER_OF - 34)) | (1 << (WJSCParser.CHARACTER_OF - 34)) | (1 << (WJSCParser.DIGIT - 34)) | (1 << (WJSCParser.BOOLEAN_LITERAL - 34)) | (1 << (WJSCParser.CHARACTER_LITERAL - 34)) | (1 << (WJSCParser.PAIR_LITERAL - 34)) | (1 << (WJSCParser.STRING_LITERAL - 34)) | (1 << (WJSCParser.LPAREN - 34)))) !== 0) || _la === WJSCParser.IDENTIFIER) {
					{
					this.state = 234;
					this.argList();
					}
	...
	public baseType(): BaseTypeContext {
		...
		try {
			...
			this.state = 259;
			_la = this._input.LA(1);
			if (!(((((_la - 57)) & ~0x1F) === 0 && ((1 << (_la - 57)) & ((1 << (WJSCParser.INTEGER - 57)) | (1 << (WJSCParser.BOOLEAN - 57)) | (1 << (WJSCParser.CHARACTER - 57)) | (1 << (WJSCParser.STRING - 57)) | (1 << (WJSCParser.ANY - 57)))) !== 0))) {
	...
	public arithmeticOperator(): ArithmeticOperatorContext {
		...
		try {
			...
			this.state = 368;
			_la = this._input.LA(1);
			if (!(((((_la - 31)) & ~0x1F) === 0 && ((1 << (_la - 31)) & ((1 << (WJSCParser.MULTIPLY - 31)) | (1 << (WJSCParser.DIVIDE - 31)) | (1 << (WJSCParser.MODULO - 31)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public comparisonOperator(): ComparisonOperatorContext {
		...
		try {
			...
			this.state = 372;
			_la = this._input.LA(1);
			if (!(((((_la - 36)) & ~0x1F) === 0 && ((1 << (_la - 36)) & ((1 << (WJSCParser.GREATER_THAN - 36)) | (1 << (WJSCParser.GREATER_EQUAL - 36)) | (1 << (WJSCParser.LESS_THAN - 36)) | (1 << (WJSCParser.LESS_EQUAL - 36)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public unaryOperator(): UnaryOperatorContext {
		...
		try {
			...
			this.state = 380;
			_la = this._input.LA(1);
			if (!(((((_la - 35)) & ~0x1F) === 0 && ((1 << (_la - 35)) & ((1 << (WJSCParser.MINUS - 35)) | (1 << (WJSCParser.LOGICAL_NEGATION - 35)) | (1 << (WJSCParser.LENGTH - 35)) | (1 << (WJSCParser.ORDER_OF - 35)) | (1 << (WJSCParser.CHARACTER_OF - 35)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public static readonly _serializedATN: string =
		...
		"\t\x03\t\x03\t\x03\t\x03\t\x03\t\x03\t\x03\t\x03\t\x03\t\x03\t\x05\t\xCC" +
		...
		"\x0E\x0E\xF9\v\x0E\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x05\x0F\xFF\n\x0F\x03" +
		"\x10\x03\x10\x03\x10\x05\x10\u0104\n\x10\x03\x11\x03\x11\x03\x12\x03\x12" +
		"\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x05\x12\u0111" +
		"\n\x12\x03\x12\x03\x12\x03\x12\x07\x12\u0116\n\x12\f\x12\x0E\x12\u0119" +
		...
		"\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15" +
		"\x03\x15\x07\x15\u0150\n\x15\f\x15\x0E\x15\u0153\v\x15\x03\x16\x05\x16" +
		"\u0156\n\x16\x03\x16\x06\x16\u0159\n\x16\r\x16\x0E\x16\u015A\x03\x17\x03" +
		"\x17\x03\x17\x03\x17\x03\x17\x06\x17\u0162\n\x17\r\x17\x0E\x17\u0163\x03" +
		"\x18\x03\x18\x03\x18\x03\x18\x07\x18\u016A\n\x18\f\x18\x0E\x18\u016D\v" +
		...
		"&)\x04\x02**,,\x05\x02%%1135\x03\x02\x11\x15\u019E\x02@\x03\x02\x02\x02" +
		"\x04^\x03\x02\x02\x02\x06`\x03\x02\x02\x02\b\x8B\x03\x02\x02\x02\n\x8D" +
		"\x03\x02\x02\x02\f\x95\x03\x02\x02\x02\x0E\xA7\x03\x02\x02\x02\x10\xCB" +
		"\x03\x02\x02\x02\x12\xCD\x03\x02\x02\x02\x14\xD1\x03\x02\x02\x02\x16\xD9" +
		"\x03\x02\x02\x02\x18\xF0\x03\x02\x02\x02\x1A\xF2\x03\x02\x02\x02\x1C\xFE" +
		"\x03\x02\x02\x02\x1E\u0103\x03\x02\x02\x02 \u0105\x03\x02\x02\x02\"\u0110" +
		"\x03\x02\x02\x02$\u011A\x03\x02\x02\x02&\u0124\x03\x02\x02\x02(\u0135" +
		"\x03\x02\x02\x02*\u0155\x03\x02\x02\x02,\u015C\x03\x02\x02\x02.\u0165" +
		"\x03\x02\x02\x020\u0172\x03\x02\x02\x022\u0174\x03\x02\x02\x024\u0176" +
		"\x03\x02\x02\x026\u0178\x03\x02\x02\x028\u017A\x03\x02\x02\x02:\u017C" +
		"\x03\x02\x02\x02<\u017E\x03\x02\x02\x02>\u0180\x03\x02\x02\x02@D\x07\f" +
		...
		"\x02\x03R\x03\x03\x02\x02\x02ST\x07\x06\x02\x02TW\x07:\x02\x02UV\x07\n" +
		"\x02\x02VX\x07J\x02\x02WU\x03\x02\x02\x02WX\x03\x02\x02\x02X_\x03\x02" +
		"\x02\x02YZ\x07\x06\x02\x02Z[\x05\x06\x04\x02[\\\x07\t\x02\x02\\]\x07:" +
		"\x02\x02]_\x03\x02\x02\x02^S\x03\x02\x02\x02^Y\x03\x02\x02\x02_\x05\x03" +
		"\x02\x02\x02`e\x07J\x02\x02ab\x07E\x02\x02bd\x07J\x02\x02ca\x03\x02\x02" +
		...
		"\x02\x02jk\x03\x02\x02\x02kl\x05\x1E\x10\x02lm\x07J\x02\x02mo\x07A\x02" +
		"\x02np\x05\n\x06\x02on\x03\x02\x02\x02op\x03\x02\x02\x02pq\x03\x02\x02" +
		"\x02qr\x07B\x02\x02rs\x07\x0E\x02\x02st\x05\x0E\b\x02tu\x07\r\x02\x02" +
		"u\x8C\x03\x02\x02\x02vx\x07\x05\x02\x02wv\x03\x02\x02\x02wx\x03\x02\x02" +
		"\x02xy\x03\x02\x02\x02yz\x07\x07\x02\x02z{\x05\x1E\x10\x02{|\x07J\x02" +
		"\x02|~\x07A\x02\x02}\x7F\x05\n\x06\x02~}\x03\x02\x02\x02~\x7F\x03\x02" +
		"\x02\x02\x7F\x80\x03\x02\x02\x02\x80\x81\x07B\x02\x02\x81\x8C\x03\x02" +
		"\x02\x02\x82\x83\x07\b\x02\x02\x83\x84\x05\x1E\x10\x02\x84\x85\x07J\x02" +
		"\x02\x85\x87\x07A\x02\x02\x86\x88\x05\n\x06\x02\x87\x86\x03\x02\x02\x02" +
		"\x87\x88\x03\x02\x02\x02\x88\x89\x03\x02\x02\x02\x89\x8A\x07B\x02\x02" +
		...
		"\x07E\x02\x02\x8F\x91\x05\f\x07\x02\x90\x8E\x03\x02\x02\x02\x91\x94\x03" +
		...
		"J\x02\x02\x97\r\x03\x02\x02\x02\x98\x99\b\b\x01\x02\x99\xA8\x07\x0F\x02" +
		...
		"\x02\x02\xA9\xAA\f\x03\x02\x02\xAA\xAB\x07F\x02\x02\xAB\xAD\x05\x0E\b" +
		...
		"\xB7\xB8\x07\x19\x02\x02\xB8\xCC\x03\x02\x02\x02\xB9\xBA\x07\x1A\x02\x02" +
		"\xBA\xBB\x05(\x15\x02\xBB\xBC\x07\x1C\x02\x02\xBC\xBD\x05\x0E\b\x02\xBD" +
		"\xBE\x07\x1D\x02\x02\xBE\xCC\x03\x02\x02\x02\xBF\xC0\x07\x1B\x02\x02\xC0" +
		"\xC1\x07A\x02\x02\xC1\xC2\x05\x0E\b\x02\xC2\xC3\x07F\x02\x02\xC3\xC4\x05" +
		"(\x15\x02\xC4\xC5\x07F\x02\x02\xC5\xC6\x05\x0E\b\x02\xC6\xC7\x07B\x02" +
		"\x02\xC7\xC8\x07\x1C\x02\x02\xC8\xC9\x05\x0E\b\x02\xC9\xCA\x07\x1D\x02" +
		"\x02\xCA\xCC\x03\x02\x02\x02\xCB\xB1\x03\x02\x02\x02\xCB\xB9\x03\x02\x02" +
		"\x02\xCB\xBF\x03\x02\x02\x02\xCC\x11\x03\x02\x02\x02\xCD\xCE\x05\x16\f" +
		"\x02\xCE\xCF\x070\x02\x02\xCF\xD0\x05\x18\r\x02\xD0\x13\x03\x02\x02\x02" +
		"\xD1\xD2\x05\x1E\x10\x02\xD2\xD3\x07J\x02\x02\xD3\xD4\x070\x02\x02\xD4" +
		"\xD5\x05\x18\r\x02\xD5\x15\x03\x02\x02\x02\xD6\xDA\x07J\x02\x02\xD7\xDA" +
		"\x05,\x17\x02\xD8\xDA\x05\x1C\x0F\x02\xD9\xD6\x03\x02\x02\x02\xD9\xD7" +
		"\x03\x02\x02\x02\xD9\xD8\x03\x02\x02\x02\xDA\x17\x03\x02\x02\x02\xDB\xF1" +
		"\x05(\x15\x02\xDC\xF1\x05.\x18\x02\xDD\xDE\x072\x02\x02\xDE\xDF\x07A\x02" +
		"\x02\xDF\xE0\x05(\x15\x02\xE0\xE1\x07E\x02\x02\xE1\xE2\x05(\x15\x02\xE2" +
		"\xE3\x07B\x02\x02\xE3\xF1\x03\x02\x02\x02\xE4\xF1\x05\x1C\x0F\x02\xE5" +
		"\xE8\x07\x1E\x02\x02\xE6\xE7\x07J\x02\x02\xE7\xE9\x07\v\x02\x02\xE8\xE6" +
		"\x03\x02\x02\x02\xE8\xE9\x03\x02\x02\x02\xE9\xEA\x03\x02\x02\x02\xEA\xEB" +
		"\x07J\x02\x02\xEB\xED\x07A\x02\x02\xEC\xEE\x05\x1A\x0E\x02\xED\xEC\x03" +
		"\x02\x02\x02\xED\xEE\x03\x02\x02\x02\xEE\xEF\x03\x02\x02\x02\xEF\xF1\x07" +
		"B\x02\x02\xF0\xDB\x03\x02\x02\x02\xF0\xDC\x03\x02\x02\x02\xF0\xDD\x03" +
		"\x02\x02\x02\xF0\xE4\x03\x02\x02\x02\xF0\xE5\x03\x02\x02\x02\xF1\x19\x03" +
		"\x02\x02\x02\xF2\xF7\x05(\x15\x02\xF3\xF4\x07E\x02\x02\xF4\xF6\x05(\x15" +
		"\x02\xF5\xF3\x03\x02\x02\x02\xF6\xF9\x03\x02\x02\x02\xF7\xF5\x03\x02\x02" +
		"\x02\xF7\xF8\x03\x02\x02\x02\xF8\x1B\x03\x02\x02\x02\xF9\xF7\x03\x02\x02" +
		"\x02\xFA\xFB\x07\x1F\x02\x02\xFB\xFF\x05(\x15\x02\xFC\xFD\x07 \x02\x02" +
		"\xFD\xFF\x05(\x15\x02\xFE\xFA\x03\x02\x02\x02\xFE\xFC\x03\x02\x02\x02" +
		"\xFF\x1D\x03\x02\x02\x02\u0100\u0104\x05 \x11\x02\u0101\u0104\x05\"\x12" +
		"\x02\u0102\u0104\x05$\x13\x02\u0103\u0100\x03\x02\x02\x02\u0103\u0101" +
		"\x03\x02\x02\x02\u0103\u0102\x03\x02\x02\x02\u0104\x1F\x03\x02\x02\x02" +
		"\u0105\u0106\t\x02\x02\x02\u0106!\x03\x02\x02\x02\u0107\u0108\b\x12\x01" +
		"\x02\u0108\u0109\x05 \x11\x02\u0109\u010A\x07C\x02\x02\u010A\u010B\x07" +
		"D\x02\x02\u010B\u0111\x03\x02\x02\x02\u010C\u010D\x05$\x13\x02\u010D\u010E" +
		"\x07C\x02\x02\u010E\u010F\x07D\x02\x02\u010F\u0111\x03\x02\x02\x02\u0110" +
		"\u0107\x03\x02\x02\x02\u0110\u010C\x03\x02\x02\x02\u0111\u0117\x03\x02" +
		"\x02\x02\u0112\u0113\f\x04\x02\x02\u0113\u0114\x07C\x02\x02\u0114\u0116" +
		"\x07D\x02\x02\u0115\u0112\x03\x02\x02\x02\u0116\u0119\x03\x02\x02\x02" +
		"\u0117\u0115\x03\x02\x02\x02\u0117\u0118\x03\x02\x02\x02\u0118#\x03\x02" +
		"\x02\x02\u0119\u0117\x03\x02\x02\x02\u011A\u011B\x07?\x02\x02\u011B\u011C" +
		"\x07A\x02\x02\u011C\u011D\x05&\x14\x02\u011D\u011E\x07E\x02\x02\u011E" +
		"\u011F\x05&\x14\x02\u011F\u0120\x07B\x02\x02\u0120%\x03\x02\x02\x02\u0121" +
		"\u0125\x05 \x11\x02\u0122\u0125\x05\"\x12\x02\u0123\u0125\x07?\x02\x02" +
		"\u0124\u0121\x03\x02\x02\x02\u0124\u0122\x03\x02\x02\x02\u0124\u0123\x03" +
		"\x02\x02\x02\u0125\'\x03\x02\x02\x02\u0126\u0127\b\x15\x01\x02\u0127\u0136" +
		"\x05*\x16\x02\u0128\u0136\x05,\x17\x02\u0129\u012A\x05<\x1F\x02\u012A" +
		"\u012B\x05(\x15\t\u012B\u0136\x03\x02\x02\x02\u012C\u012D\x07A\x02\x02" +
		"\u012D\u012E\x05(\x15\x02\u012E\u012F\x07B\x02\x02\u012F\u0136\x03\x02" +
		"\x02\x02\u0130\u0136\x07J\x02\x02\u0131\u0136\x077\x02\x02\u0132\u0136" +
		"\x078\x02\x02\u0133\u0136\x07:\x02\x02\u0134\u0136\x079\x02\x02\u0135" +
		"\u0126\x03\x02\x02\x02\u0135\u0128\x03\x02\x02\x02\u0135\u0129\x03\x02" +
		"\x02\x02\u0135\u012C\x03\x02\x02\x02\u0135\u0130\x03\x02\x02\x02\u0135" +
		"\u0131\x03\x02\x02\x02\u0135\u0132\x03\x02\x02\x02\u0135\u0133\x03\x02" +
		"\x02\x02\u0135\u0134\x03\x02\x02\x02\u0136\u0151\x03\x02\x02\x02\u0137" +
		"\u0138\f\x10\x02\x02\u0138\u0139\x050\x19\x02\u0139\u013A\x05(\x15\x11" +
		"\u013A\u0150\x03\x02\x02\x02\u013B\u013C\f\x0F\x02\x02\u013C\u013D\x05" +
		"2\x1A\x02\u013D\u013E\x05(\x15\x10\u013E\u0150\x03\x02\x02\x02\u013F\u0140" +
		"\f\x0E\x02\x02\u0140\u0141\x054\x1B\x02\u0141\u0142\x05(\x15\x0F\u0142" +
		"\u0150\x03\x02\x02\x02\u0143\u0144\f\r\x02\x02\u0144\u0145\x056\x1C\x02" +
		"\u0145\u0146\x05(\x15\x0E\u0146\u0150\x03\x02\x02\x02\u0147\u0148\f\f" +
		"\x02\x02\u0148\u0149\x058\x1D\x02\u0149\u014A\x05(\x15\r\u014A\u0150\x03" +
		"\x02\x02\x02\u014B\u014C\f\v\x02\x02\u014C\u014D\x05:\x1E\x02\u014D\u014E" +
		"\x05(\x15\f\u014E\u0150\x03\x02\x02\x02\u014F\u0137\x03\x02\x02\x02\u014F" +
		"\u013B\x03\x02\x02\x02\u014F\u013F\x03\x02\x02\x02\u014F\u0143\x03\x02" +
		"\x02\x02\u014F\u0147\x03\x02\x02\x02\u014F\u014B\x03\x02\x02\x02\u0150" +
		"\u0153\x03\x02\x02\x02\u0151\u014F\x03\x02\x02\x02\u0151\u0152\x03\x02" +
		"\x02\x02\u0152)\x03\x02\x02\x02\u0153\u0151\x03\x02\x02\x02\u0154\u0156" +
		"\t\x03\x02\x02\u0155\u0154\x03\x02\x02\x02\u0155\u0156\x03\x02\x02\x02" +
		"\u0156\u0158\x03\x02\x02\x02\u0157\u0159\x076\x02\x02\u0158\u0157\x03" +
		"\x02\x02\x02\u0159\u015A\x03\x02\x02\x02\u015A\u0158\x03\x02\x02\x02\u015A" +
		"\u015B\x03\x02\x02\x02\u015B+\x03\x02\x02\x02\u015C\u0161\x07J\x02\x02" +
		"\u015D\u015E\x07C\x02\x02\u015E\u015F\x05(\x15\x02\u015F\u0160\x07D\x02" +
		"\x02\u0160\u0162\x03\x02\x02\x02\u0161\u015D\x03\x02\x02\x02\u0162\u0163" +
		"\x03\x02\x02\x02\u0163\u0161\x03\x02\x02\x02\u0163\u0164\x03\x02\x02\x02" +
		"\u0164-\x03\x02\x02\x02\u0165\u016E\x07C\x02\x02\u0166\u016B\x05(\x15" +
		"\x02\u0167\u0168\x07E\x02\x02\u0168\u016A\x05(\x15\x02\u0169\u0167\x03" +
		"\x02\x02\x02\u016A\u016D\x03\x02\x02\x02\u016B\u0169\x03\x02\x02\x02\u016B" +
		"\u016C\x03\x02\x02\x02\u016C\u016F\x03\x02\x02\x02\u016D\u016B\x03\x02" +
		"\x02\x02\u016E\u0166\x03\x02\x02\x02\u016E\u016F\x03\x02\x02\x02\u016F" +
		"\u0170\x03\x02\x02\x02\u0170\u0171\x07D\x02\x02\u0171/\x03\x02\x02\x02" +
		"\u0172\u0173\t\x04\x02\x02\u01731\x03\x02\x02\x02\u0174\u0175\t\x03\x02" +
		"\x02\u01753\x03\x02\x02\x02\u0176\u0177\t\x05\x02\x02\u01775\x03\x02\x02" +
		"\x02\u0178\u0179\t\x06\x02\x02\u01797\x03\x02\x02\x02\u017A\u017B\x07" +
		".\x02\x02\u017B9\x03\x02\x02\x02\u017C\u017D\x07/\x02\x02\u017D;\x03\x02" +
		"\x02\x02\u017E\u017F\t\x07\x02\x02\u017F=\x03\x02\x02\x02\u0180\u0181" +
		"\t\b\x02\x02\u0181?\x03\x02\x02\x02$DJNW^eiow~\x87\x8B\x92\xA7\xAE\xCB" +
		"\xD9\xE8\xED\xF0\xF7\xFE\u0103\u0110\u0117\u0124\u0135\u014F\u0151\u0155" +
		"\u015A\u0163\u016B\u016E";
...
export class BaseTypeContext extends ParserRuleContext {
	...
	public ANY(): TerminalNode | undefined { return this.tryGetToken(WJSCParser.ANY, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
